...
var askforfield = function(req, index, InstanceId, fields, next){
    ...
    var url = "http://"+servername+":"+port+path+addurl;
...
var getgraph = function(req, InstanceId, level, next){
    ...
    var url = "http://"+servername+":"+port+path + InstanceId + 
...
router.get('/:ClassId', function(req, res, next) {
    ...
    console.log("dataset id="+req.cookies.dataset);

    var url = "http://"+host+":"+port+path+req.params.ClassId;
...
router.get('/details/:Id', function (req, res, next) {
    ...
    var url = "http://"+option.host+":"+option.port+option.path + Id;
...
router.get('/user/:Id', function (req, res, next) {
    ...
    var url = "http://"+option.host+":"+option.port+option.path;
...
var getObject = function(req, ObjectId, next){
    ...
    var url = "http://"+servername+":"+port+path;
