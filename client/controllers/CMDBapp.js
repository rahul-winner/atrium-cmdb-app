...
//Info : Cookies are set at Home page.
        ...
        var req = $http.get("api/utilities/Dataset")
            .success(function(response){
                ...
                if (response.status != 200){
                    ...
                    console.log("response from dataset api:"+response.data.entries);
    ...
    $scope.SavePrefs = function(){
        console.log("Stringified Dataset : "+ JSON.stringify($scope.dataset));
        console.log("Dataset actual id: "+ $scope.dataset.values.CoreDatasetId);
